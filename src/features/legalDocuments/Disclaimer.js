...
const Disclaimer = () => {
  return (
    <>
      <Helmet>
        <title>Disclaimer | {CONFIG.APP_NAME}</title>
      </Helmet>
      <PageMainCard
        ...
        <Container>
          <Row>
            <Col>
              ...
              <h6>Definitions</h6>For the purposes of this Disclaimer:
              <ul>
                <li>
              ...
              <p>
                ...
                Disclaimer has been created with the help of the Disclaimer
                Generator.
              </p>
              <p>
              ...
              <h4 className="mt-5 mb-3">External Links Disclaimer</h4>
              <p>
              ...
              <h4 className="mt-5 mb-3">Errors and Omissions Disclaimer</h4>
              <p>
              ...
              <h4 className="mt-5 mb-3">Fair Use Disclaimer</h4>
              <p>
              ...
              <h4 className="mt-5 mb-3">Views Expressed Disclaimer</h4>
              <p>
              ...
              <h4 className="mt-5 mb-3">No Responsibility Disclaimer</h4>
              <p>
              ...
              <h4 className="mt-5 mb-3">"Use at Your Own Risk" Disclaimer</h4>
              <p>
