...
const PrivacyPolicies = () => {
  return (
    ...
    >
      <p className="mt-5">
        These Privacy Policies describes Our policies and procedures on the
      ...
      <h4 className="mt-5 mb-3">1. Interpretation and Definitions</h4>
      <h5 className="ms-3">1.1 Interpretation</h5>
      <p className="ms-3">
      ...
      <h5 className="ms-3">1.2 Definitions</h5>
      <p className="ms-3">For the purposes of these Privacy Policies:</p>
      <ul className="ms-2">
        <li>
      ...
      <h4 className="mt-5 mb-3">2. Collecting and Using Your Personal Data</h4>
      <h5 className="ms-3">2.1 Types of Data Collected</h5>
      <h6 className="ms-6">2.1.1 Personal Data</h6>
      <p className="ms-6">
      ...
      <h6 className="ms-6">2.1.2 Usage Data</h6>
      <p className="ms-6">
      ...
      <h6 className="ms-6">2.1.3 Tracking Technologies and Cookies</h6>
      <p className="ms-6">
      ...
      <ul className="ms-6">
        ...
        <li>
          ...
          <p className="mb-0">Type: Session Cookies</p>
          <p className="mb-0">Administer by: Us</p>
          <p>
        ...
        <li>
          ...
          <p className="mb-0">Type: Persistent Cookies</p>
          <p className="mb-0">Administer by: Us</p>
          <p>
      ...
      <h5 className="ms-3">2.2 Use of Your Personal Data</h5>
      <p className="ms-3">
      ...
      <h4 className="mt-5 mb-3">3. Retention of Your Personal Data</h4>
      <p>
      ...
      <h4 className="mt-5 mb-3">4. Transfer of Your Personal Data</h4>
      <p>
      ...
      <h4 className="mt-5 mb-3">5. Disclosure of Your Personal Data</h4>
      <h5 className="ms-3">5.1 Business Transactions</h5>
      <p className="ms-3">
      ...
      <h5 className="ms-3">5.2 Law enforcement</h5>
      <p className="ms-3">
        Under certain circumstances, the Company may be required to disclose
        Your Personal Data if required to do so by law or in response to valid
        requests by public authorities (e.g. a court or a government agency).
      </p>
      <h5 className="ms-3">5.3 Other legal requirements</h5>
      <p className="ms-3">
      ...
      <h4 className="mt-5 mb-3">6. Security of Your Personal Data</h4>
      <p>
      ...
      <h4 className="mt-5 mb-3">7. Children's Privacy </h4>
      <p>
      ...
      <h4 className="mt-5 mb-3">8. Links to Other Websites</h4>
      <p>
      ...
      <h4 className="mt-5 mb-3">9. Changes to this Privacy Policy</h4>
      <p>
      ...
      <h4 className="mt-5 mb-3">10. Contact Us</h4>
      <p>
        If you have any questions about these Privacy Policies, You can contact
        us by Email:{" "}
        <a
