...
const TermsConditions = () => {
  return (
    <PageMainCard
      ...
      subTitle="Last modified: 9 Oct 2022"
    >
      <h4 className="mt-5 mb-3">Interpretation and Definitions</h4>
      ...
      <h6>Definitions</h6>For the purposes of these Terms and Conditions:
      <ul>
        <li>
        ...
        <li>
          ...
          "Us", or "Our" in this Agreement) refers to Oases Solar.
        </li>
        <li>
          <strong>Device</strong> means any device that can access the Sevice
          such as a computer, a cellphone or a digital tablet.
        </li>
        <li>
          <strong>Service</strong> refers to this Website / Web Application.
        </li>
        <li>
          ...
          and the Company regarding the us of the Service.
        </li>
        <li>
        ...
        <li>
          <strong>Website / Web Application</strong> refers to Oases Solar,
          accessible from www.oases-solar.com
        </li>
        <li>
      ...
      <h4 className="mt-5 mb-3">Acknowledgment</h4>
      <p>
      ...
      <h4 className="mt-5 mb-3">Links to Other Websites</h4>
      <p>
      ...
      <h4 className="mt-5 mb-3">Termination</h4>
      <p>
      ...
      <h4 className="mt-5 mb-3">"AS IS" and "AS AVAILABLE" Disclaimer</h4>
      <p>
      ...
      <h4 className="mt-5 mb-3">Governing Law</h4>
      <p>
      ...
      <h4 className="mt-5 mb-3">Disputes Resolution</h4>
      <p>
      ...
      <h4 className="mt-5 mb-3">For European Union (EU) Users</h4>
      <p>
        If You are a European Union consumer, you will benefit from any
        mandatory provisions of the law of the country in which you are resident
        in.
      </p>
      <h4 className="mt-5 mb-3">United States Legal Compliance</h4>
      <p>
      ...
      <h4 className="mt-5 mb-3">Severability and Waiver</h4>
      <h6>Severability</h6>
      <p>
      ...
      <h4 className="mt-5 mb-3">Translation Interpretation</h4>
      <p>
      ...
      <h4 className="mt-5 mb-3">Changes to These Terms and Conditions</h4>
      <p>
      ...
      <p>
        ...
        contact us by Email:&nbsp;
        <a
          href="mailto:info@oases-solar.com"
          rel="noopener noreferrer nofollow"
        >
          info@oases-solar.com
        </a>
      </p>
    </PageMainCard>
  );
