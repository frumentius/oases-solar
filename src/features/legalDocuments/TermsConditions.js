...
const TermsConditions = () => {
  return (
    <>
      <Helmet>
        <title>Terms and Conditions | {CONFIG.APP_NAME}</title>
      </Helmet>
      <PageMainCard
        ...
        <Container>
          <Row>
            <Col>
              ...
              <h6>Definitions</h6>For the purposes of these Terms and
              Conditions:
              <ul>
                <li>
                ...
                <li>
                  ...
                  agreement between You and the Company regarding the us of the
                  Service.
                </li>
                <li>
