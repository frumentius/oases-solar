...
const FinancialAnalysisProApp = () => {
  return (
    <PageMainCard colorClass="bg-gradient-primary" title="Financial Analysis Pro" subTitle="Coming Soon">
      ...
      <div className="justify-content-start d-flex px-2 py-1">
        ...
        <div className="ps-2">
          <small>Calculates NPV, LCOE, Amortization, CRF, IRR, EAA</small>
        </div>
      </div>
      <div className="justify-content-start d-flex px-2 py-1">
        <div>
        ...
        <div className="ps-2">
          <small>
            Detailed input of PV-Plant's materials (include listing of material
            costs and lifetime of materials)
          </small>
        </div>
      </div>
      <div className="justify-content-start d-flex px-2 py-1">
        ...
        <div className="ps-2">
          <small>Detailed input for all kinds of fixed and running costs</small>
        </div>
      </div>
      <div className="justify-content-start d-flex px-2 py-1">
        <div>
      ...
      <p className="mt-3">
        Financial analysis PRO is also included in PV-design off-grid PRO.
      </p>
      <p>
        Financial analysis PRO is separately offered for user, who doesn't need
        technical designing tool. This tool is suitable for off-grid and on-grid
        pv projects
      </p>
    </PageMainCard>
  );
